...
const CODEX_ICON_MASK = dataUrlFromSvg(`
...
export function CodexLogoShimmer({
  className,
}: {
  className?: string;
}): React.ReactElement {
    ...
    >
      ...
      <div
        className={clsx(
          ...
          !reducedMotion && "codex-logo-shimmer-overlay",
        )}
        style={{
          WebkitMaskImage: `url(${CODEX_ICON_MASK})`,
          maskImage: `url(${CODEX_ICON_MASK})`,
